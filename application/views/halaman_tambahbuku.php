...
<head>
    ...
    <title>Bukabuku.com - Member - Input buku</title>
        ...
        <div style="width: 600px; margin: auto; padding: 5px;">
            ...
            <div class="tabbox_container">
                <table class="lines width_full">
                    ...
                    <tr valign="top">
                        <td>Pengarang </td>
                        <td> <input name="data[Member][email]" style="width:250px" class="text" maxlength="100" type="email" id="MemberEmail" required="required" /></td>
                    </tr>
                    <tr valign="top">
                        <td> Harga </td>
                        <td>
