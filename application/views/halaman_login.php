...
<head>
    ...
    <title>Bukabuku.com - Member - Login</title>
...
<div class="page_header">
    <div class="headers">
        <div class="header_row_2">
            <div class="logo">
                <a href="/">
<img src="http://www.bukabuku.com/img/logo.gif" alt="" /></a>
            </div>
            <div class="features">
        ...
        <div class="header_row_3" id="header_row_3">
            <div style="float: left; width: auto; display: none;" class="headerLogo">
                <a href="/">
<img src="http://www.bukabuku.com/img/logo-bukabuku.png" alt="" /></a>&nbsp;
            </div>
            ...
            <div style="width: auto;">
                <form action="/searches/search" style="width:auto" id="SearchForm" method="post" accept-charset="utf-8">
                    ...
                    <div style="float: right; width: auto;">
                        <a href="javascript:void(0)" onclick="$('#SearchForm').submit()" class="search_button"><span class="helper"></span>
<img src="http://www.bukabuku.com/img/icon-search.png" alt=""/></a> </div>
